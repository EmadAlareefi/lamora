    ...
    <div className="w-full bg-cotton overflow-hidden">
      <main className="w-full h-full relative flex flex-col min-h-[100vh] justify-start items-center">
        <div className="relative">
          ...
          <Image alt="main-img-desktop" fetchPriority="high" width="1512" height="816" decoding="async" data-nimg="1" className="img-desktop w-full h-auto" src="https://dsh6y5eym1jrl.cloudfront.net/_next/image?url=https%3A%2F%2Fd166chel5lrjm5.cloudfront.net%2Fimages%2Fhome%2Fimages%2Fslider%2F20250309_slider_hero_desktop_1.jpg&amp;w=3840&amp;q=100 1x">
          </Image>
          </a>
